...
public class ThemeManager {
    ...
    public static final String DARK_THEME_PATH = "/snapmacro/styles/dark_theme.css";
    public static final String WHITE_THEME_PATH = "/snapmacro/styles/white_theme.css";
